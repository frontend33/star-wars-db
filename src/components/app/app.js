          ...
          <Router>
            <div className="stardb-app">
              ...
              <Switch>
                ...
                />
                {/* 1 стратегия Если не один из роутов не сработал можно вызвать Redirect 
                2 стратегия Если мы не передадим path такой роут все равно будет работать и если он стоит последним срабатывать всегда когда не один из роутов не сработал
                */}
                <Route
